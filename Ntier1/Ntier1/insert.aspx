<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="insert.aspx.cs" Inherits="Ntier1.insert" %>
    ...
    <form id="form1" runat="server" autocomplete="off">
        <div class="container" style="padding-top:150px">
            ...
            <asp:TextBox ID="TextBox4" class="form-control" runat="server" placeholder="Address" ></asp:TextBox>     
                ...
                <asp:Button ID="Button1" class="btn btn-block btn-success" runat="server" Text="Insert" OnClick="Button1_Click"  />
            </div>
        </div>
